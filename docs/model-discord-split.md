...
| **3** | The twelve effects, a rank per pull request (3a-3f) | Six ranks | 3a-3b done (PR #229, PR #TBD); 3c-3f open |
...
| 3b | O1 | Low Pass, Skilled Pass | **Done (PR #TBD).** Nothing was left to move -- Phase 2's step already carried both cards -- so the rank is its evidence: ten fixtures and the `key=` round trip |

...
**The seed has been re-picked three times.** Once when PR #243 and PR
...
game from the first roll. And when Smooth stopped reading the spaces the
ball passes through (2026-09-24), which took seed 134's Smooth offer
away. Each time the seed was swept and scored on the coverage below, not
chosen.
